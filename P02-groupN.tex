...
% The paper that we read explored the notion of the Raft being an improvement on Paxos by implementing both in a test virtual environment. The authors also looked at how to optimize the Raft algorithm.
%I replaced this with the last sentence. I think it sounds better, but someone should verify.
